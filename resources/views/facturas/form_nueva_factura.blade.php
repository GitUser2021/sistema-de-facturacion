    ...
    <div class="nueva-factura-left">
        <div class="container div-left">
            ...
            <form action="{{ $titulo == 'EDITAR'? '/actualizar_factura/'.$id:'/agregar_factura' }}"
                ...
                <input type="text" id="cliente-encontrado" class="form-control" value="Cliente: {{$cliente->Nombre}}"
                       disabled>
                <button class="btn btn-primary mt-auto" form="form-factura" id="btn-guardar-factura" disabled>GUARDAR
                    FACTURA
                </button>
                <button class="btn btn-primary" form="ver-factura" id="btn-ver-factura" disabled>VER FACTURA</button>
